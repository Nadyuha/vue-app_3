        ...
        <!-- <div style="display: none">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <symbol id="icon-arrow-right" viewBox="0 0 8 14">
                    <path
                        d="M2 2h2v2H2V2zm2 2h2v2H4V4zm2 2h2v2H6V6zM4 8h2v2H4V8zm-2 2h2v2H2v-2zm-2 2h2v2H0v-2zM0 0h2v2H0V0z">
                    </path>
                </symbol>
                ...
                <form class="cart__form form" action="#" method="POST" @submit.prevent="order">
                    <div class="cart__field">
                        <div class="cart__data">
                            ...
                            <BaseFormText v-model="formData.phone" type="tel" title="Телефон" :error="formError.phone" placeholder="Введите ваш телефон"/>
                            ...
                            <BaseFormText v-model="formData.email" type="email" title="Email" :error="formError.email" placeholder="Введите ваш Email"/>
                            ...
                            <!-- <BaseFormField title="Комментарий к заказу" :error="formError.comments">
                                <textarea v-model="formData.comments" class="form__input form__input--area" name="comments"
                    ...
                    <div class="cart__block">
                        ...
                        <div class="cart__total">
                            ...
                            <p>Итого: <b>{{ totalAmound }}</b> товара на сумму <b>{{ totalPricePretty }} ₽</b></p>
                        </div>
...
import { defineComponent } from 'vue';
    ...
    export default defineComponent({
        ...
        components: {BaseFormText, BaseFormTextarea, PreloaderItem},
        computed: {
